...
- Mesh names containing `eye`, `beak`, `talon`/`claw`, `feather`/`wing` get the
  matching look; everything else is body. Feathers need UVs (u across, v base→tip)
  for the candlestick pattern.
