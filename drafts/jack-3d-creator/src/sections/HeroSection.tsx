...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* The positioning lives on the wrapper: FadeIn and Magnet each write
          their own inline transform, which would otherwise wipe the
          translate utilities that centre the portrait. */}
